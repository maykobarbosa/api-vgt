...
CREATE TABLE `empresas` (
    ...
    `reserva_financeira` INTEGER NOT NULL,
    `acordo_operacional` VARCHAR(191) NOT NULL,
    `estrutura_governanca` VARCHAR(191) NOT NULL,
    `projecao_crescimento` INTEGER NOT NULL,
    `projecao_futura` VARCHAR(191) NOT NULL,
    `competidores` VARCHAR(191) NOT NULL,
    `imposto` VARCHAR(191) NULL,
    `YTD` VARCHAR(191) NULL,
    `despesas` VARCHAR(191) NULL,
    `dividas` VARCHAR(191) NULL,
    `receitas` VARCHAR(191) NULL,
    `contratos_firmados` VARCHAR(191) NULL,
    `contratos_pendentes` VARCHAR(191) NULL,
