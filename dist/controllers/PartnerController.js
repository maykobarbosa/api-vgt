...
var PartnerController = /** @class */ (function () {
    function PartnerController() {
    }
    PartnerController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, companyId, peopleId, validaCompany, validaPeople, validaPartner, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, prismaClient_1.prismaClient.partner.findMany({
                                where: {
                                    AND: [
                                        {
                                            peopleId: peopleId
    ...
    PartnerController.prototype.searchByCompany = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    PartnerController.prototype.delete = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, releases;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, prismaClient_1.prismaClient.partner.delete({
                                where: {
                                    id: id
                                }
                            })];
